...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Categotical columns: {categorical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
            ...
            try:
                ...
                preprocessor_obj=self.get_data_transformer_object() #Make an object that does ColumnTransformation as stated above
